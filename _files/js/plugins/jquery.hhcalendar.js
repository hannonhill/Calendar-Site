    ...
    var self = this,
        ...
        fcOptions = $.extend(true, {
          ...
          eventClick: function(event, e, view) {
            ...
            // Otherwise, destroy the current popover and update the id of the popover placeholder.
            if (self.ui.hasActiveEventPopover) {
              self.ui.eventPopover.popover("destroy");
...
<ul class="unstyled">' +
    ...
    <li>
        <strong>When:</strong>
        <span class="event-date">' + whenString + '</span>
    </li>' +
            (event.location && '
    <li>
    ...
    <li>' + event.summary + '</li>' || '') +
            ...
            '
<p class="pull-right">
    <a href="' + event.url + '"' + (event.target ? ' target="_parent"' : '') + '>view event 
        <i class="icon-double-angle-right"></i>
            ...
            self.ui.eventPopover.popover({
              title: event.title + '
<a class="close" data-dismiss="popover" style="line-height:14px">?</a>',
...
<div class="btn-group" style="margin-bottom: 20px;">' +
      '
    <a class="btn btn-mini" href="#" id="categoriesToggleHide" title="Hide all events">Hide All</a>
    <a class="btn btn-mini" href="#" id="categoriesToggleShow" title="Show all events">Show All</a>' +
      '
</div>';
    ...
    $("#categoriesToggleShow").click(function(){
        $("a[id^='trigger-']", calendarsDiv).each(function(){
            var category = $(this).attr("id").replace("trigger-", "");
  ...
  Calendar.prototype.toggleEventsInCategory = function(category, showOrHide) {
    ...
    var self = this,
        events = $("." + category + (showOrHide ? "-off" : ""));
